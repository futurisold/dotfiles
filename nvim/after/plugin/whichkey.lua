...
local n_mappings = {
    ...
    { '<leader>th', function()
        _toggleterm_with_tree_fix(function() vim.cmd("ToggleTerm size=10 direction=horizontal") end)
    end, desc="Horizontal" },
    { '<leader>tv', function()
        _toggleterm_with_tree_fix(function() vim.cmd("ToggleTerm size=80 direction=vertical") end)
    end, desc="Vertical" },
    { '<leader>taf', function() _toggleterm_new("float") end,                                                                        desc="New Float" },
    { '<leader>tah', function() _toggleterm_new("horizontal", 10) end,                                                               desc="New Horizontal" },
    { '<leader>tav', function() _toggleterm_new("vertical", 80) end,                                                                 desc="New Vertical" },
